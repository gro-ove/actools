...
namespace AcTools.Tests {
    ...
    public class AiFileTest {
        ...
        private void TestTrack(string path, float length, float minWidth, float maxWidth, float lengthError = 0.002f, float widthError = 0.1f) {
        ...
        public void Main() {
            ...
            TestTrack(@"content\tracks\redbullring\ai\fast_lane.ai", 4318, 12f, 13f, 0.005f);
        }
    }
}