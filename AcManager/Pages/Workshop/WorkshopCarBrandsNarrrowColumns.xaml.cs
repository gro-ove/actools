...
namespace AcManager.Pages.Workshop {
    public partial class WorkshopCarBrandsNarrrowColumns : IParametrizedUriContent, ILoadableContent {
        ...
        private double GetTranslateX(int column) {
            switch (column) {
                case 0:
                    return Model.LayoutPhase == 0 ? 0d
        ...
        private DoubleAnimation AnimateX(double value) {
