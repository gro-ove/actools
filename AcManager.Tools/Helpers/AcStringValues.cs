...
namespace AcManager.Tools.Helpers {
    public static class AcStringValues {
        ...
        public static int? GetYearFromName([NotNull] string name) {
            ...
            if (string.IsNullOrEmpty(matched)) return null; // shouldn't really happen
        ...
        /// <summary>
        /// Converts HTML-like description to a normal one. We don’t need any YouTube players in it.
        /// </summary>
