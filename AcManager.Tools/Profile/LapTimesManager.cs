        ...
        private LapTimesManager() {
            _sources = new[] {
                ...
                new LapTimesSource(Ov1InfoSourceId,
                        "Rivali OV1 Info",
                        "Sadly, there is no information about entries date. If you need a patch for 64-bit AC or layouts support, you can get it [url=\"https://acstuff.club/f/d/15-rivali-ov1-info\"]here[/url].",
