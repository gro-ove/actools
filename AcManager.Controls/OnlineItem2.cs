...
namespace AcManager.Controls {
    public class OnlineItem2 : Control {
        // TODO: add option
        ...
        static OnlineItem2() {
            ...
            DefaultStyleKeyProperty.OverrideMetadata(typeof(OnlineItem2), new FrameworkPropertyMetadata(typeof(OnlineItem2)));
        }
        ...
        public static readonly DependencyProperty HideSourceIconsProperty = DependencyProperty.Register(nameof(HideSourceIcons), typeof(string[]),
                typeof(OnlineItem2), new PropertyMetadata(null, (o, e) => { ((OnlineItem2)o)._hideSourceIcons = (string[])e.NewValue; }));
        ...
        public static readonly DependencyProperty ServerProperty = DependencyProperty.Register(nameof(Server), typeof(ServerEntry),
                typeof(OnlineItem2), new PropertyMetadata(OnServerChanged));
        ...
        private static void OnServerChanged(DependencyObject o, DependencyPropertyChangedEventArgs e) {
            try {
                ((OnlineItem2)o).OnServerChanged((ServerEntry)e.OldValue, (ServerEntry)e.NewValue);
            } catch (Exception ex) {
                Logging.Error(ex);
            }
        }
